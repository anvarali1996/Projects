    ...
    return (
        <NavbarBs sticky="top" className="bg-white shadow-sm mb-3">
            <Container>
                ...
                <Button onClick={openCart} style={{width: "3rem", height: "3rem", position: "relative"}} variant="outline-primary" className="rounded-circle"><svg  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
